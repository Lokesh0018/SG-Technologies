  ...
  return (
    <div className="about-editorial-page" style={{ paddingTop: '15vh' }} ref={containerRef}>
      ...
      <div style={{ position: 'relative', zIndex: 1, padding: '0 5vw' }}>
        ...
        {/* PROJECTS LISTING */}
        <div style={{ borderTop: '1px solid #e0e0e0', paddingTop: '4rem', paddingBottom: '10vh' }}>
          {projects.map((proj, i) => (
            <section key={proj.id} className="about-section split-section" style={{ borderTop: i === 0 ? 'none' : '1px solid #e0e0e0', paddingTop: i === 0 ? '0' : '4rem', marginTop: i === 0 ? '0' : '2rem' }}>
